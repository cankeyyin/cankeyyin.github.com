    ...
    <div class="new_options_container">
    	...
    	<div class="new_options_container_top">
            ...
            <div class="new_options_container_top_logo">
            	<a href="http://www.themealley.com/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/skins/images/logo.png" /></a>
            </div>
            <div class="new_options_container_top_upgrade">
            	<a href="https://www.themealley.com/magazine/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/skins/images/probanner.png" /></a>
            </div>            
    	...
    	<div id="countrytabs" class="new_options_container_middle">
			...
			<ul class="shadetabs">
            	<li class="big"><a href="#country1"><h6><?php echo __('General', 'viper'); ?></h6><p><?php echo __('Settings', 'viper'); ?></p></a></li>
                <li class="small"><a href="#country2"><p><?php echo __('Social Settings', 'viper'); ?></p></a></li>
                <li class="big"><a href="#country3"><h6><?php echo __('Slider', 'viper'); ?></h6><p><?php echo __('Settings', 'viper'); ?></p></a></li>
                <li class="big"><a href="#country4"><h6><?php echo __('Layout', 'viper'); ?></h6><p><?php echo __('Settings', 'viper'); ?></p></a></li>
	            <li class="small"><a href="#country6"><p><?php echo __('MagPro Settings', 'viper'); ?></p></a></li> 
	            <li class="small"><a href="#country12"><p><?php echo __('VideoMag Settings', 'viper'); ?></p></a></li> 
	            <li class="small"><a href="#country17"><p><?php echo __('MagSeven Settings', 'viper'); ?></p></a></li> 
                <li class="small"><a href="#country20"><p><?php echo __('MagTen Settings', 'viper'); ?></p></a></li>
                <li class="small"><a href="#country21"><p><?php echo __('MagEleven Settings', 'viper'); ?></p></a></li>
                <li class="small"><a href="#country9"><p><?php echo __('Standard Blog Settings', 'viper'); ?></p></a></li>
                <li class="big"><a href="#country5"><h6><?php echo __('Sidebar', 'viper'); ?></h6><p><?php echo __('Settings', 'viper'); ?></p></a></li>
                <li class="big"><a href="#country10"><h6><?php echo __('AD', 'viper'); ?></h6><p><?php echo __('Settings', 'viper'); ?></p></a></li> 
                <li class="big"><a href="#country11"><h6><?php echo __('Footer', 'viper'); ?></h6><p><?php echo __('Settings', 'viper'); ?></p></a></li>
            </ul>        
    	...
    	<div class="new_options_container_bottom">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'viper' ) ); ?>' );" />
        </div> 
        </form>        
        </div>
